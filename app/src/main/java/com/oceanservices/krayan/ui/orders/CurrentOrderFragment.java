...
public class CurrentOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_curremt_order, container, false);
        initialize();
        onClickListeners();
        try {
            getOrders();
    ...
    public void onClickListeners(){
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(CurrentOrderFragment.this).navigate(R.id.action_nav_current_orders_to_nav_previous);
            }
        });
    }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot post : dataSnapshot.getChildren()) {
                    ...
                    if (first) {
                        ...
                        orderAdapter = new OrderAdapter(getContext(),orderDataList,CurrentOrderFragment.this);
